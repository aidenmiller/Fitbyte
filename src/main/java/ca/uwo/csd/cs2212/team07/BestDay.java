...
public class BestDay implements Serializable {
     ...
     * @param bestValue double value. The value that the user achieved in the
     * specified activity on this day
     */
     ...
     * setDate() method:
     *
     * @param date String date to set as the date relating to this BestDay
     * object
     */
     ...
     * setActivity() method:
     *
     * @param activity String of activity name associated with this BestDay
     * object
     */
     ...
     * setValue() method:
     *
     * @param value double value to set as the distance/steps/floors of this
     * best day
     */
