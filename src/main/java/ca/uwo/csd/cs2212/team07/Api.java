...
public class Api {
    ...
    /**
     * getHeartSummary() method, gets heart rate data from fitbit for any given
     * day
     *
     ...
     * @throws JSONException If there is an issue parsing the data from Fitbit's
     * response
     * @throws RefreshTokenException If there is an issue refreshing the
    ...
    /**
     * getTimeSeriesData() method: gets time series data pertaining to a
     * specific date, activity and resolution
     *
     * @param date String of the date that we are getting time series data for
     * @param activity activity that we are getting time series data for (heart,
     * steps, distance, calories)
     * @param resolution Resolution that we are accessing time series data at, 1
     * minute or 15 minutes
     * @return TimeSeriesData object with all the info within this request
     * @throws JSONException if there is an issue parsing through data returned
     * by Fitbit
     * @throws RefreshTokenException if there is an issue with the
     * authentication tokens
     */
